...
import com.yusufuzeyir.recipeapp.databinding.ActivityTatlilarSayfasiBinding

class TatlilarSayfasi : AppCompatActivity() {
    private lateinit var binding: ActivityTatlilarSayfasiBinding
    private lateinit var db: FirebaseFirestore
    private lateinit var PostArrayList: ArrayList<Post>
    private lateinit var feedadapter: CustomAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTatlilarSayfasiBinding.inflate(layoutInflater)
