...
import com.yusufuzeyir.recipeapp.databinding.ActivityAnaYemekSayfasiBinding

class AnaYemekSayfasi : AppCompatActivity() {
    private lateinit var binding: ActivityAnaYemekSayfasiBinding
    private lateinit var db: FirebaseFirestore
    private lateinit var PostArrayList: ArrayList<Post>
    private lateinit var feedadapter: CustomAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAnaYemekSayfasiBinding.inflate(layoutInflater)
