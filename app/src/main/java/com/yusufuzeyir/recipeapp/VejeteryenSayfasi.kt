...
import com.yusufuzeyir.recipeapp.databinding.ActivityVejeteryenSayfasiBinding

class VejeteryenSayfasi : AppCompatActivity() {
    private lateinit var binding: ActivityVejeteryenSayfasiBinding
    private lateinit var db: FirebaseFirestore
    private lateinit var PostArrayList: ArrayList<Post>
    private lateinit var feedadapter: CustomAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityVejeteryenSayfasiBinding.inflate(layoutInflater)
    ...
    private fun getdata() {
        db.collection("Vejeteryenler").addSnapshotListener { value, error ->
            if (error != null) {
