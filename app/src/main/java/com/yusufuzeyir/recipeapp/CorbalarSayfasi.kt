...
import com.yusufuzeyir.recipeapp.databinding.ActivityCorbalarSayfasiBinding
import io.grpc.Context

class CorbalarSayfasi : AppCompatActivity() {
    private lateinit var binding: ActivityCorbalarSayfasiBinding
    private lateinit var db: FirebaseFirestore
    private lateinit var PostArrayList: ArrayList<Post>
    private lateinit var feedadapter: CustomAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCorbalarSayfasiBinding.inflate(layoutInflater)
    ...
    private fun getdata() {
        db.collection("Çorbalar").addSnapshotListener { value, error ->
            if (error != null) {
